...
public class Compile {
	...
	public static String compile(String file_path, String desti_path, boolean add, String addition) {
		//check message
		...
		if(filekind == 1 || filekind == 2){
			...
			if(check()){
				...
				String retCmd = ExecuteWindowsCommand.execute(compileCmd + " " + addition);
				String errorMsg = "\nThe result:\n" 
						+ retCmd
			...
			//linux
				...
				String retCmd = ExecuteLinuxCommand.execute(compileCmd + " " + addition);
				String errorMsg = "\nThe result:\n" 
						+ retCmd
						+ "\nAny problems in the process:\n"
						+ "\t1.check the gpp_path\n"
...
//				retCmd = ExecuteLinuxCommand.execute(src_cmd);
	...
	public static String compile(String file_path){
		...
		return compile(file_path, work_dir, false, "");
	}
	
	//overload function
	public static String compile(String file_path, String desti_path, String GPP_path){
		set_gpp_path(GPP_path);
		return compile(file_path, desti_path, false, "");
	}

	public static String compile(String file_path, String desti_path, String addition, boolean add){
		return compile(file_path, desti_path, add, addition);
	}
